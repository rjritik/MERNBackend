...
#define RemoteUpdateEncryptKey	0X7F87B752	// Code used to protect AUTHORIZE.DAT file

/* S-LOK related definitions */
#define RequiredSN     0X0000 // Required serial number
#define TargetLicense  0X0000 // License value

#define UserPin       "12345678"